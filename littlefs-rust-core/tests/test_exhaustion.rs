...
use common::{BadblockBehavior, Lfs, LfsConfig, lfs_emubd_setwear, lfs_emubd_wear, test_prng};
...
async fn verify_after_exhaustion<'a>(
    lfs: &mut Lfs<'a>,
    config: &LfsConfig<'a>,
    prefix: &str,
    files: u32,
...
#[lfs_test]
#[tokio::test]
async fn test_exhaustion_wear_leveling<'a>(
    cfg: &LfsConfig<'a>,
