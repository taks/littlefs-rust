...
/// #endif
/// ```
pub fn lfs_dir_commitcrc(lfs: &mut crate::fs::Lfs<T, U> commit: &mut LfsCommit) -> Result<(), Error> {
...
pub unsafe fn lfs_dir_alloc(lfs: &mut crate::fs::Lfs<T, U> dir: &mut LfsMdir) -> Result<(), Error> {
    use crate::bd::bd::lfs_bd_read;
...
/// }
/// ```
pub fn lfs_dir_needsrelocation(lfs: &Lfs<T, U> dir: &LfsMdir) -> bool {
    let cfg = unsafe { lfs.cfg.as_ref().unwrap() };
