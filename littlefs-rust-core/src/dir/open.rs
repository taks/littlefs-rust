...
/// }
/// ```
pub fn lfs_dir_open_(lfs: &mut crate::fs::Lfs<T, U> dir: &mut LfsDir, path: &str) -> Result<(), Error> {
...
/// }
/// ```
pub fn lfs_dir_close_(lfs: &mut crate::fs::Lfs<T, U> dir: &mut LfsDir) -> Result<(), Error> {
...
/// }
/// ```
pub fn lfs_dir_tell_(_lfs: *mut crate::fs::Lfs<T, U> dir: *const LfsDir) -> crate::types::lfs_soff_t {
...
/// }
/// ```
pub fn lfs_dir_rewind_(lfs: &mut crate::fs::Lfs<T, U> dir: &mut LfsDir) -> Result<(), Error> {
