...
///
/// C: lfs.c:3246-3264
pub fn lfs_file_close_(lfs: &mut crate::fs::Lfs<T, U> file: &mut LfsFile) -> Result<(), Error> {
...
/// }
/// ```
pub fn lfs_file_relocate(lfs: &mut crate::fs::Lfs<T, U> file: &mut LfsFile) -> Result<(), Error> {
...
/// }
/// ```
pub fn lfs_file_outline(lfs: &mut crate::fs::Lfs<T, U> file: &mut LfsFile) -> Result<(), Error> {
    use crate::block_alloc::alloc::lfs_alloc_ckpoint;
...
/// }
/// ```
pub fn lfs_file_flush(lfs: &mut crate::fs::Lfs<T, U> file: &mut LfsFile) -> Result<(), Error> {
...
/// }
/// ```
pub fn lfs_file_sync_(lfs: &mut crate::fs::Lfs<T, U> file: &mut LfsFile) -> Result<(), Error> {
...
///
/// C: lfs.c:3840-3850
pub fn lfs_file_rewind_(lfs: &mut crate::fs::Lfs<T, U> file: &mut LfsFile) -> Result<(), Error> {
    lfs_file_seek_(
        lfs,
        file,
        0,
...
/// }
/// ```
pub fn lfs_file_size_(_lfs: &Lfs<T, U> file: &LfsFile) -> crate::types::lfs_soff_t {
    if (file.flags as i32 & LFS_F_WRITING) != 0 {
