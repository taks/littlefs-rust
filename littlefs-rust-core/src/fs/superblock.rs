...
/// }
/// ```
pub fn lfs_fs_prepsuperblock(lfs: &mut super::lfs::Lfs<T, U> needssuperblock: bool) {
...
///
/// C: lfs.c:4894-4904
pub fn lfs_fs_preporphans(lfs: &mut super::lfs::Lfs<T, U> orphans: i8) -> Result<(), Error> {
...
pub fn lfs_fs_prepmove(lfs: *mut super::lfs::Lfs<T, U> id: u16, pair: *const [lfs_block_t; 2]) {
...
///
/// C: lfs.c:4916-4953
pub fn lfs_fs_desuperblock(lfs: &mut super::lfs::Lfs<T, U>) -> Result<(), Error> {
...
/// #endif
/// ```
pub fn lfs_fs_demove(lfs: &mut super::lfs::Lfs<T, U>) -> Result<(), Error> {
...
///
/// C: lfs.c:4991-5120
pub fn lfs_fs_deorphan(lfs: &mut super::lfs::Lfs<T, U> powerloss: bool) -> Result<(), Error> {
...
///
/// C: lfs.c:5122-5140
pub fn lfs_fs_forceconsistency(lfs: &mut super::lfs::Lfs<T, U>) -> Result<(), Error> {
